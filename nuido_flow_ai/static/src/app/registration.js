...
import { AiMemoryPortModel } from "@nuido_flow_ai/models/ports/ai_memory_port";
import { ListMemoryNode } from "@nuido_flow_ai/components/ai/list_memory_node";
import { ListMemoryNodeModel } from "@nuido_flow_ai/models/ai/list_memory_node";
...
nuidoNodeRegistry.add(ListMemoryNode.name, {
    component: ListMemoryNode,
    model: ListMemoryNodeModel
});
...
registry.category(NuidoPortRegistryName).add(AiMemoryPort.name, {
    component: AiMemoryPort,
    model: AiMemoryPortModel
});
...
aiMemoryNodeMenuItems.items.push({
    title: "List Memory",
    icon: "/nuido_flow_ai/static/images/list-box.svg",
    type: ListMemoryNode.name
});
